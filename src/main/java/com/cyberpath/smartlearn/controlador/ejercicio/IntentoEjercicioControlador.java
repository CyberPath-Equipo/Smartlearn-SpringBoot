...
import com.cyberpath.smartlearn.dto.ejercicio.IntentoEjercicioDto;
...
import com.cyberpath.smartlearn.servicio.servicio.ejercicio.IntentoEjercicioServicio;
...
public class IntentoEjercicioControlador {
    ...
    private IntentoEjercicioDto convertToDto(IntentoEjercicio intento) {
        return IntentoEjercicioDto.builder()
                ...
                .fecha(intento.getFecha() != null ? intento.getFecha().toString() : null)
                .estado(intento.getEstado() != null ? intento.getEstado().toString() : "completado")
    ...
    private IntentoEjercicio mapDtoToEntity(IntentoEjercicioDto dto) {
        return IntentoEjercicio.builder()
                ...
                .estado(dto.getEstado() != null ? IntentoEjercicio.EstadoIntento.valueOf(dto.getEstado()) : IntentoEjercicio.EstadoIntento.completado)
                .build();
    }
}